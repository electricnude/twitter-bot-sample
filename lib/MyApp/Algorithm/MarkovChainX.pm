package MyApp::Algorithm::MarkovChainX;
use strict;
use warnings;
use Carp;
...
use base 'MyApp::Algorithm::MarkovChainX::Base';
...
sub new {
    ...
    my MyApp::Algorithm::MarkovChainX $self = $class->SUPER::new(@_);
...
sub increment_seen {
    my MyApp::Algorithm::MarkovChainX $self = shift;
...
MyApp::Algorithm::MarkovChainX - Object oriented Markov chain generator

=head1 SYNOPSIS

  use MyApp::Algorithm::MarkovChainX;

  my $chain = MyApp::Algorithm::MarkovChainX::->new();
...
MyApp::Algorithm::MarkovChainX is an implementation of the Markov Chain
algorithm within an object container.

It is implemented as a base class, C<MyApp::Algorithm::MarkovChainX::Base>,
with storage implementations of a hash (C<MyApp::Algorithm::MarkovChainX>),
and an fairly memory efficent implementation using C<glib>
(C<MyApp::Algorithm::MarkovChainX::GHash>).  DBI and MLDBM-friendly versions
are planned.
...
=item MyApp::Algorithm::MarkovChainX::->new() or $obj->new()

Creates a new instance of the MyApp::Algorithm::MarkovChainX class.
